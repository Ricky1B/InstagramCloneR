            ...
            case R.id.btnShareImage:
                if( receivedImageBitmap != null){
                    if(edtDescription.getText().toString().equals("")){
                        FancyToast.makeText(getContext(),"You must specify a description", FancyToast.LENGTH_LONG, FancyToast.ERROR,false).show();
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if(e==null){
                                    ...
                                    FancyToast.makeText(getContext(),"Unknown Error: "+ e.getMessage(), FancyToast.LENGTH_LONG, FancyToast.ERROR,false).show();
